...
abstract public class DatabaseModel {
    ...
    public static final int TYPE_NOTE_CAMERA = 2;
    public static final int TYPE_NOTE_AUDIO = 3;
    public static final int TYPE_NOTE_CHECKLIST = 4;
    ...
    public DatabaseModel(Cursor c) {
        ...
        this.isLocked = c.getInt(c.getColumnIndex(OpenHelper.COLUMN_LOCK)) == 1;
    }
